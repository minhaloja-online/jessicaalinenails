...
export const PADRAO = {
  ...
  marca: {
    nome1: "Jessica Aline",
    nome2: "Nails",
    local: "Estúdio de unhas",
    slogan: "Unhas com hora marcada",
    resumo: "Manicure, pedicure, unhas em gel e nail art com hora marcada."
  },

  hero: {
    rotulo: "Manicure e nail art",
  ...
  profissionais: [
    {
      ...
      foto: "",
      whatsapp: "",            // preencha no painel: só números, ex. 5593999998888
      instagram: "",           // endereço completo do perfil, ex. https://www.instagram.com/seu_perfil/
      visivel: true,
      horarios: {
  ...
  depoimentos: {
    ...
    convite: "Já foi atendida no estúdio? Conte como foi — sua avaliação aparece aqui depois de conferida.",
  ...
  final: {
    ...
    botao: "Falar com o estúdio"
  },

  /* Tudo aqui é preenchido no painel, na aba Contato.
     Enquanto estiver em branco, o site mostra o aviso no lugar. */
  contato: {
    whatsapp: "",
    whatsappTexto: "Informe o WhatsApp no painel",
    mensagem: "Olá! Vim pelo site e gostaria de agendar um horário.",
    instagram: "",
    instagramUsuario: "",
    mapsLink: "https://www.google.com/maps",
    mapsBusca: "Brasil",
    endereco: "Informe o endereço no painel",
    horario: "Segunda a sábado, com hora marcada"
  },

  aparencia: {
    corFundo:    "#EDEBF0",   // pérola fria
    corTexto:    "#191520",
    corPrimaria: "#8E2F4A",   // cereja: a cor forte do site
    corDourada:  "#9A90AE",   // pérola lilás: fios, bordas e marcadores
    corEscura:   "#201A2B",   // tinta violeta dos blocos escuros
    fonteTitulos: "Prata",
    fonteTexto:   "Work Sans",
    tamanhoBase:  16,
    escalaTitulos: 1
  },
